...
/**
Ñòðóêòóðà êàê ýëåìåíò ñïèñêà è õðàíåíèÿ äàííûõ.
*/
template<class T>
struct node
{
    T data;			// Äàííûå
    node<T>* next;	// Àäðåñ ñëåäóþùåãî ýëåìåíòà ñïèñêà
    node() : next(nullptr) {}
};

/**
Ðåàëèçàöèÿ êëàññà èòåðàòîðà äëÿ îðãàíèçàöèè äîñòóïà
ê ýëåìåíòàì êîíòåéíåðà.
*/
template<class T>
class s_iterator
{
